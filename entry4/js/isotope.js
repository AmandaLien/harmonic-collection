...
(function(t) {
    ...
    function o(o) {
      function s() {
        if (!d) {
          ...
          if (p = function() {
            ...
            return function(e) {
              var i = t(e);
              return i || n("Style returned " + i + ". Are you running this code in a hidden iframe on Firefox? " + "See http://bit.ly/getsizeiframe"),
              i
            }
          } (), h = o("boxSizing")) {
      ...
      function a(t) {
        if (s(), "string" == typeof t && (t = document.querySelector(t)), t && "object" == typeof t && t.nodeType) {
          ...
          var S = e(o.height);
          return S !== !1 && (n.height = S + (b ? 0 : v + z)),
          n.innerWidth = n.width - (g + L),
          n.innerHeight = n.height - (v + z),
      ...
      function u(t, e) {
        ...
        n = t.runtimeStyle,
        r = n && n.left;
        return r && (n.left = t.currentStyle.left),
        i.left = e,
        e = i.pixelLeft,
        i.left = o,
        r && (n.left = r),
  ...
  function(t) {
    ...
    "function" == typeof define && define.amd ? define("outlayer/item", ["eventEmitter/EventEmitter", "get-size/get-size", "get-style-property/get-style-property"], n) : "object" == typeof exports ? module.exports = n(require("wolfy87-eventemitter"), require("get-size"), require("desandro-get-style-property")) : (t.Outlayer = {},
  ...
  function(t) {
    ...
    d = "function" == typeof HTMLElement || "object" == typeof HTMLElement ?
    function(t) {
  ...
  function(t) {
    ...
    function r(t, i, r, u, h) {
      ...
      return d.prototype.remove = function(t) {
        t = o(t);
        var e = this.getItems(t);
        if (c.call(this, t), e && e.length) for (var i = 0,
        r = e.length; r > i; i++) {
          var s = e[i];
